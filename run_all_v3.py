...
import importlib.util   # FIX: must import submodule explicitly, not just 'importlib'
import sys
...
# ─────────────────────────────────────────────────────────────────────────────
# SPOTIPY AUGMENTATION — uncomment after setting env vars:
#   export SPOTIPY_CLIENT_ID=your_id
#   export SPOTIPY_CLIENT_SECRET=your_secret
# Then re-run; augmented features are auto-detected in FEATURE SETUP above.
# ─────────────────────────────────────────────────────────────────────────────
...
print("Re-run this script to use augmented features (auto-detected above).")
